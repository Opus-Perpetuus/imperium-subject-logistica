...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-logistica"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-logistica"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-logistica \
    KIRLET_TECHNICAL_ID=subject-logistica \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
